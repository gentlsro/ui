...
const classes = computed(() => {
  return [
    props.vertical ? 'separator-vertical' : 'separator-horizontal',
    {
      'separator--spaced': props.spaced,
      'separator--inset': props.inset,
    },
  ]
})
</script>
...
.separator {
  @apply relative flex flex-center border-true-gray/40 rounded-full;
