...
export const DIALOG_DEFAULT_PROPS = {
  ui: {
    ...
    dialogClass(payload: {
      ...
      const base = 'max-h-[min(95%,var(--dialogMaxHeight))] max-w-95vw pointer-events-auto flex flex-col dark:bg-black/95 bg-white backdrop-blur-2px rounded-custom overflow-auto'
